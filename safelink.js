...
.breadcrumb{margin:20px 0 5px;}
  ...
  <b:if cond='data:blog.url == &quot;http://www.safelink.ga/p/generate.html&quot;'>
<style type='text/css'>
...
<header itemscope='itemscope' itemtype='https://schema.org/WPHeader'>
      <b:section class='header' id='header' maxwidgets='1' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='ragland (Header)' type='Header' version='1'>
          <b:widget-settings>
...
protected_links = "www.safelink.ga,blogspot.com,youtube.com,facebook.com,google.com,twitter.com"; 
  (function() {
    ...
    sl.src = 'https://cdn.rawgit.com/dedi96/safelink/813ce72f/safelinkga.js';
...
//<![CDATA[
  ...
  input.onkeyup = function() {
    if (input.value != "") {
      output.value = "http://www.safelink.ga/p/generate.html?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
  ...
  <div class='widget-content popular-posts'>
    ...
    <b:include name='quickedit'/>
           ...
           <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList'>
             <b:widget-settings>
               <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'https://ragland1.blogspot.com/', 'title': 'Home', 'position': 0}}]]></b:widget-setting>
